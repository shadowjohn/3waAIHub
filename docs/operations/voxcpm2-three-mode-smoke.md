...
$values = [
    ...
    'ASR_RUNTIME_SETTINGS' => hub_runtime_settings_path(dirname(hub_path((string)$services['ASR']['compose_file']))),
    ...
    'TTS_RUNTIME_SETTINGS' => hub_runtime_settings_path(dirname(hub_path((string)$services['TTS']['compose_file']))),
