...
def assert_health(payload: object) -> None:
    ...
    if payload.get("ready") is not True:
        raise AcceptanceUnavailable("image-tools model snapshot is not ready")
    if not isinstance(payload.get("runtime_level"), str) or not isinstance(payload.get("runtime_ready"), bool):
        raise AcceptanceUnavailable("incomplete image-tools health response")
