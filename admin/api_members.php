    ...
    <table>
        ...
        <?php foreach ($members as $member): ?>
            <tr>
                ...
                <td>
                    <a class="button" href="api_member_edit.php?id=<?= (int)$member['id'] ?>">Edit</a>
                    <a class="button" href="api_tokens.php?member_id=<?= (int)$member['id'] ?>">Tokens</a>
                    <a class="button" href="api_usage.php?member_id=<?= (int)$member['id'] ?>">Usage</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
