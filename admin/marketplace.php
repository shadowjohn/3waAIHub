...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    if (!hub_check_csrf(false)) {
        ...
        $actionMap = [
            ...
            'provision_breezyvoice' => 'breezyvoice_provision',
        ...
        if (
            ...
            || ($action === 'provision_breezyvoice' && hub_breezyvoice_provisioning_plan($db, $service) === null)
...
$dictionary = [
    ...
    'action_breezyvoice_provision' => hub_i18n_text('準備 BreezyVoice 模型'),
        ...
        <?php else: ?>
            <section class="service-grid" aria-label="<?= hub_h(hub_i18n_text('服務列表')) ?>">
                <?php foreach ($services as $service): ?>
                    ...
                    $breezyVoiceProvisionPlan = hub_breezyvoice_provisioning_plan($db, $service);
                    ...
                    <article class="service-card"
                        ...
                        <form class="service-action-form" method="post" data-service-refresh-form="<?= $serviceId ?>">
                            ...
                            <div class="service-operations">
                                ...
                                <?php endif; ?>
                                <?php if ($breezyVoiceProvisionPlan !== null): ?>
                                    <button name="action" value="provision_breezyvoice" type="submit"><?= hub_h(hub_i18n_text('準備 BreezyVoice 模型')) ?></button>
                                <?php endif; ?>
                                <?php if ($manualVision): ?>
