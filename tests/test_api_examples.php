...
hub_test('audio task documentation publishes async delivery and runtime contracts', function (): void {
    ...
    foreach (['php scripts/init_db.php', 'scripts/callback_worker.php', 'scripts/prune_retention.php', 'audio_packs_acceptance.php', 'sync_max_duration_seconds=30'] as $needle) {
