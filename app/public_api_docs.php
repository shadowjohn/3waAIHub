...
function hub_public_api_yolo_model_services(): array
{
    return [
        ...
        [
            ...
            'description' => 'Query Hub registry plus CPU and GPU warm-pool state for a model_ref.',
            'method' => 'GET',
            'content_type' => '',
            ...
            'output_keys' => ['ok', 'model_ref', 'version_id', 'model_version_id', 'state', 'cpu_available', 'warm_state', 'cpu.service_available', 'cpu.actual_state', 'cpu.warm_state', 'gpu.service_available', 'gpu.service.runtime_status', 'gpu.actual_state', 'gpu.blocked_reason', 'task_type', 'sha256'],
            'error_codes' => ['model_ref_required', 'model_not_found', 'missing_token', 'token_mode_not_allowed'],
            'task_api' => [],
        ],
        [
            'mode' => 'yolo_model_prewarm_cpu',
            'pack_id' => 'yolo-serving',
            'name' => 'YOLO Model Prewarm CPU',
            'description' => 'Prewarm one registered YOLO Detect model_ref in the yolo-cpu resident process cache.',
            'method' => 'POST',
            'content_type' => 'multipart/form-data',
            'endpoint' => 'api.php?mode=yolo_model_prewarm_cpu',
            'url' => hub_public_api_mode_url('yolo_model_prewarm_cpu'),
            'execution_type' => 'sync_api',
            'runtime_level' => 'L3-storage-mount',
            'task_type' => '',
            'input_fields' => [
            ...
            'error_codes' => ['cpu_slot_occupied', 'cpu_service_unavailable', 'cpu_warm_failed', 'model_not_found', 'model_artifact_missing', 'missing_token', 'token_mode_not_allowed'],
            'task_api' => [],
        ],
        [
            'mode' => 'yolo_model_unload_cpu',
            'pack_id' => 'yolo-serving',
            'name' => 'YOLO Model Unload CPU',
            'description' => 'Unload the single yolo-cpu resident model cache. Registry model artifacts are not deleted.',
            'method' => 'POST',
            'content_type' => 'multipart/form-data',
            'endpoint' => 'api.php?mode=yolo_model_unload_cpu',
            'url' => hub_public_api_mode_url('yolo_model_unload_cpu'),
            'execution_type' => 'sync_api',
            'runtime_level' => 'L3-storage-mount',
            'task_type' => '',
            'input_fields' => [
            ...
            'output_keys' => ['ok', 'model_ref', 'version_id', 'model_version_id', 'service_key', 'slot_no', 'run_id'],
            'error_codes' => ['cpu_not_ready', 'cpu_model_slot_mismatch', 'cpu_unload_failed', 'model_not_found', 'missing_token', 'token_mode_not_allowed'],
            'task_api' => [],
        ],
        [
